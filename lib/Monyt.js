  ...
  (0, _createClass3.default)(Monyt, [{
    ...
    value: function listen(callback) {
      ...
      return this.aggregator.listen(function (metricses) {
        _promise2.default.all(_this.senders.map(function (sender) {
          return sender.send(metricses);
        })).then(function (results) {
          return callback && callback(_promise2.default.resolve(results));
        }).catch(function (error) {
          return callback && callback(_promise2.default.reject(error));
        });
      });
    }
    ...
    value: function getLogger(options) {
      return _LoggerFactory2.default.getLogger(options);
    }
